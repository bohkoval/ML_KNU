...
data <- read.csv("./lab2_data/mlbootcamp5_train.csv", sep = ";")
head(data, 10)
```
...
```
Точність не зазнала змін при кастомізації cross validation parameters та налаштуванні tree parameters до дефолтних значень, результат не змінився
```